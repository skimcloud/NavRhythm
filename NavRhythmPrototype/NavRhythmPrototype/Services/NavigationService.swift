...
final class NavigationService: ObservableObject {
    ...
    func getDistanceToManeuver(position: MapCameraPosition, maneuverCoordinates: [CLLocationCoordinate2D], routeCoordinates: [CLLocationCoordinate2D], maneuverCoordinateIndex: Int, routeCoordinateIndex: Int) -> NavigationUpdate {
